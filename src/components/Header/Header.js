...
export default function Header(props) {
  return (
    <div>
        ...
        <header className={`header navbar-expand-lg bg-${props.mode==='dark'?'dark':'secondary'} border col-lg-12 col-mb-12 col-sm-12`}>
        <div className={`nav-scroller navbar-expand-lg  shadow-sm d-flex justify-content-end bg-${props.mode==='dark'?'dark':'secondary'}`}>
            <nav className={`nav bg-${props.mode==='dark'?'dark':'secondary'} navbar-expand-lg  " aria-label="Secondary navigation d-flex justify-content-end" id='link-style`}>
                <a className="nav-link  " id='link-style' aria-current="page" href="/"><b><i className="bi bi-phone text-warning"></i> Call: 01776979756</b></a>
                ...
                <a className="nav-link dropdown-toggle me-1 " data-bs-toggle="dropdown" aria-expanded="false" href="/" id='link-style'><i className="bi bi-bookmark text-warning"></i> Blogs  </a> 
