    ...
    <div>
        ...
        <div className="nav-scroller  shadow-sm d-flex justify-content-end bg-light">
            <nav className="nav bg-light" aria-label="Secondary navigation d-flex justify-content-end" id='link-style'>
                <a className="nav-link active border border-2" id='link-style' aria-current="page" href="/"><b>Call: 01776979756</b></a>
                <a className="nav-link border border-2" href="/" id='link-style'><i class="bi bi-geo-alt"></i>
                Track Order
                <span className="badge text-bg-warning rounded-pill align-text-bottom">7</span>
                </a>
                <a className="nav-link border border-2" href="/" id='link-style'>Compare</a>
                <a className="nav-link dropdown-toggle border border-2" data-bs-toggle="dropdown" aria-expanded="false" href="/" id='link-style'>Blogs</a> 
            </nav>
        </div>
        </header>
...
<nav className="py-2 bg-body border-bottom shadow p-3 mb-1 bg-body rounded">
      ...
      <a href="https://web-design-and-tech-tips.com/">
       ...
       <div className="d-flex justify-content-end p-2">
            ...
            <li className="nav-item"><a href="/" className="nav-link link-dark px-2"><i class="bi bi-bag"></i></a></li>
                 <li className="nav-item"><a href="/" className="nav-link link-dark px-2"><i class="bi bi-person"></i></a></li>
